...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function Qs(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xr(),fragmentShader:`
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function ea(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xr(),fragmentShader:`
